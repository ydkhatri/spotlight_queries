iOS Notes
```SQL
SELECT kMDItemContentType, _kMDItemExternalID, _kMDItemStorageSize, kMDItemKind, kMDItemDisplayName,
kMDItemPrimaryRecipientEmailAddresses, kMDItemAccountType, 
...
FROM "Spotlight-NSFileProtectionComplete-store" -- replace with table name
